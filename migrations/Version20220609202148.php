...
final class Version20220609202148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lendings (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, book_id INT NOT NULL, start_date DATE NOT NULL, end_date DATE DEFAULT NULL, INDEX IDX_8273353D49CB4726 (account_id), INDEX IDX_8273353D71868B2E (book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE lendings ADD CONSTRAINT FK_8273353D49CB4726 FOREIGN KEY (account_id) REFERENCES account (id)');
        $this->addSql('ALTER TABLE lendings ADD CONSTRAINT FK_8273353D71868B2E FOREIGN KEY (book_id) REFERENCES book (id)');
    }
